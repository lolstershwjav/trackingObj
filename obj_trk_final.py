...
video = cv2.VideoCapture("/Users/abhijoy/Desktop/Visual Studio: Coding/Python/objectTracking/project-C119-template/footvolleyball.mp4")
#load tracker 
...
while True:
    ...
    if success:
        ...
        cv2.putText(img, "Lost message", (75,90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255), 2)
